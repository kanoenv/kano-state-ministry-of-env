      ...
      <div className="container-custom relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 py-12">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href="tel:+2348030719901" className="text-slate-300 hover:text-emerald-400 transition-colors">
                  +234 803 071 9901
                </a>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-5 w-5 text-emerald-400" />
                <a href="mailto:info@environment.kn.gov.ng" className="text-slate-300 hover:text-emerald-400 transition-colors break-all">
          ...
          <div className="space-y-6">
            ...
            {/* Language Selector */}
            <div className="mt-6">
              <h5 className="text-lg font-semibold mb-3 text-slate-200">Language</h5>
              <div className="flex items-center space-x-4">
                <button className="px-4 py-2 bg-emerald-600 text-white rounded-lg font-medium transition-colors">
                  English
                </button>
                <button className="px-4 py-2 bg-white/10 text-slate-300 hover:bg-white/20 hover:text-white rounded-lg font-medium transition-colors backdrop-blur-sm border border-white/20">
                  Hausa
                </button>
              </div>
            </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-center md:text-left">
              ...
              <p className="text-slate-500 text-xs mt-1">
                Government of Kano State, Federal Republic of Nigeria
              </p>
            </div>
